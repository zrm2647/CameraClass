...
{
	super::InitWindow("Exam_01_A"); // Window Name
	m_pSystem->SetWindowWidth(800); // Window Width
	m_pSystem->SetWindowHeight(800);// Window Height
}
void AppClass::InitVariables(void)
{
	//Set the camera position
	m_pCameraMngr->SetPositionTargetAndView(
		vector3(0.0f, 3.0f, 15.0f),
...
void AppClass::Display(void)
{
	//clear the screen
	ClearScreen();
	m_pMeshMngr->AddGridToRenderListBasedOnCamera(m_pCameraMngr->GetCameraMode());//Render the grid based on the camera's mode
